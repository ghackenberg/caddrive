...
\section{Introduction}
    ...
    % passt gut für anforderungen von problem:
    ...
    % müsste nochmal unterteilt werden
    ...
    % Ich finde den Abschnitt etwas zu lang. Irgendwie kommen wir noch nicht richtig auf den Punkt. Vielleicht ein paar Inhalte in den Kontext schieben, um das Problem kürzer und prägnanter formulieren zu können?
    
    % von solution herausgenommen und dort gelöscht:
    % A part of the problem is that tools to support product development do not cover all essential aspects such as project management, requirement engineering and solution engineering.

    % Problem noch deutlicher herausarbeiten: Projektpläne, Anforderungen/Änderungswünsche, und CAD-Modelle sind klassisch isoliert. Je komplexer, desto problematischer den Überblick zu behalten. Folge: Es dauert lange Informationen zu finden, oder Informationen werden übersehen, was unnötige Iterationen verursacht.

    % Für mich ist das Problem, dass Projektmanager, Anforderungsingenieure und Produktdesigner mit unterschiedlichen Werkzeugen arbeiten. Die Werkzeuge haben wiederum keine einheitliche und integrierte Datenbasis. Die Brüche in den Datenmodellen verursachen Probleme bei der Kommunikation und Entscheidungsfindung. Diese Probleme ziehen schließlich unnötige Kosten für die Produktentwicklung nach sich.

    % Für mich sollte die Problemdefinition nicht viel umfangreicher sein. Sonst verliert man sich irgendwie. Außerdem würde sich hier jetzt gut unsere Kurzbeschreibung der Lösung anschließen: Also die Entwicklung eines Werkzeuges, dass die drei genannten Rollen integriert.
