\section{Our solution}
    ...
    % Entities: User, Produkt- hier hängen die anderen Entities dran. api sucht immer nach den ids
    % wie interagieren die entities miteinander
    % wichtige attribute beschreiben und welchen zweck sie haben.
    % wo ist das STL file?
    % verweise auf erdiagram
    % toplevel ist user und product
