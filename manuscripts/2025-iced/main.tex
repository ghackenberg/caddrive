...
In our questionnaire we assessed prior experiences in different fields such as CAD/CAM, simulation (i.e.\ FEM/CFD/MBS/MPS/DES), PDM/PLM, QFD/DSM, product management/design, system/requirements/mechanical/electrical/software engineering, project management, agile methodology, and design thinking.
Furthermore, in each category the participants could selected between novice, junior, professional, senior, and expert experience levels, while these different experience levels have not been further specified.
