...
class AttachmentManagerImpl extends AbstractManager<Attachment> {
    ...
    async addAttachment(data: AttachmentAddData, files?: { audio?: Blob, image?: File, pdf?: File, video?: File }) {
    ...
    async updateAttachment(id: string, data: AttachmentUpdateData, files?: { audio?: Blob, image?: File, pdf?: File, video?: File }) {
