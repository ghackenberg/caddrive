...
class PostProcessor():
    ...
    def __init__(self, outputsDir: str, jobName: str):
        ...
        # Results as Pandas
        self.pd_DeplNoda = pandas.DataFrame(columns=['GROUPNAME', 'NOEUD', 'COOR1', 'COOR2', 'COOR3', 'DEPL1', 'DEPL2', 'DEPL3'])   # Result for nodal displacements as pandas dataframe (all nodes in model!)
        self.pd_ForcNoda = pandas.DataFrame(columns=['GROUPNAME', 'NOEUD', 'COOR1', 'COOR2', 'COOR3', 'FORC1', 'FORC2', 'FORC3'])   # Result for nodal forces in nub connections as pandas dataframe
        
        self.pd_resultsMinMax = pandas.DataFrame(columns=['DESCRIPTION', 'VALUE', 'COOR1', 'COOR2', 'COOR3'])
    ...
    def _convertResu2Pandas(self):
        ...
        self.pd_DeplNoda = pandas.DataFrame(columns=['GROUPNAME', 'NOEUD', 'COOR1', 'COOR2', 'COOR3', 'DEPL1', 'DEPL2', 'DEPL3'])
        self.pd_ForcNoda = pandas.DataFrame(columns=['GROUPNAME', 'NOEUD', 'COOR1', 'COOR2', 'COOR3', 'FORC1', 'FORC2', 'FORC3'])
            
        # Open the result file to read the nodal forces
        fin = open(self.fNameResu, 'r')
