...
#  - read Lego part library from file, e.g.  './resources/libLegoParts.lib'
#
# Usage:
...
class leoFeaModelDescription():
    ...
    def readFileLDR(self, fileNameLib, fileNameLDR):
        ...
        fin = open(f"./output/{self.fileNameLDR}", "r")
    ...
    def getStrTableLeoFeaModel(self):
        ...
        fid = open('./output/tableLeoFeaModel.txt', 'w')
    ...
    def _readPartLib(self):
        ...
        # Reads the library for Lego parts from file, e.g. './resources/libLegoParts.txt'
