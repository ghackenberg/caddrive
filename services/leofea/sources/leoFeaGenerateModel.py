...
class leoFeaGenerateModel():
    ...
    pathResources = RESOURCES_DIR
    templateCommFileStatic = f"{RESOURCES_DIR}/templateCommStatic.comm"
    templateCommFileModal = f"{RESOURCES_DIR}/templateCommModal.comm"
    templateCommFileDyn = f"{RESOURCES_DIR}/templateCommDyn.comm"
    templateCommFileConvertMesh = f"{RESOURCES_DIR}/convertMesh.comm"
    ...
    def __init__(self, jobName):
        ...
        self.fileNameDebug = f"{OUTPUTS_DIR}/dbg_nodeConn.txt"
    ...
    def _writeCommSimulation(self):
        ...
        fnameComm = f'{OUTPUTS_DIR}/{self.jobName}.comm'
    ...
    def _writeMailFile(self):
        ...
        # Write MAIL file
        mailFileName = f'{OUTPUTS_DIR}/{self.jobName}.mail'
