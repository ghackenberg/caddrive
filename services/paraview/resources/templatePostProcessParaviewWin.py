...
s8_tableLeoCADprmed = MEDReader(registrationName=f'{jobname}.rmed', FileName=f'{filename}.rmed')
...
# save screenshot
SaveScreenshot('./output/screenshot.png', renderView1, ImageResolution=[887, 579])
...
SaveScreenshot('./output/job.png', renderView1, ImageResolution=[887, 579])
